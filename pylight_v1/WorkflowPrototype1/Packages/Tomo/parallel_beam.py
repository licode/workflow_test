...
# - Specifically, interfering with arguments has not been checked
# - Look into the way the projection is calculated, also look at
#   the reconstruction calculation - I think I should be dividing
#   the projection values by 4 before returning, which would suggest
#   that the reconstruction routine needs a similar adjustment.
# - After figuring out the above point, apply the same fix (if any)
#   to the code in art.py.
