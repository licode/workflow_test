...
def DPC(filename):
    ...
    energy = 19.5
    data_dir = data_path + 'DPC/SOFC/SOFC_'
    ...
    aa  = loadtxt(data_path+'DPC/a copy.txt')
    gxx = loadtxt(data_path+'DPC/gx copy.txt')
    gyy = loadtxt(data_path+'DPC/gy copy.txt')
...
#scipy.misc.imsave('a.jpg', a)
    savetxt(data_path+'a_test.txt', a)
#    scipy.misc.imsave('gx.jpg', gx)
    savetxt(data_path+'gx_test.txt', gx)
#scipy.misc.imsave('gy.jpg', gy)
    savetxt(data_path+'gy_test.txt', gy)
...
#    scipy.misc.imsave('phi_test.jpg', phi)
    savetxt(data_path+'phi_test.txt', phi)
    aphi = array(phi)
