...
def gen_diff_phase(node_id, node_num, proc_num):
    #############################
    ## start the process
    #############################
    t0 = time()
    ...
    dataDir = '/kbase/home/wxu/WorkflowPrototype/Data/DPC/SOFC/SOFC_'
    directory = '/kbase/home/wxu/WorkflowPrototype/Data/DPC/experiment'
...
if __name__ == '__main__':
    ...
    gen_diff_phase(sys.argv[1], sys.argv[2], sys.argv[3])
